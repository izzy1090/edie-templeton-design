...
function ImagesPage () {
    ...
    const images = [ 
        {key: 1, highResImage: bedroom2, compressedImage: bedroom2Compressed, width: 1200, height: 1800, alt: 'Empty bedroom with chair and fur rug draped over the chair.'}, 
        {key: 2, highResImage: livingRoom1, compressedImage: livingRoom1Compressed, width: 1800, height: 1200, alt: '72 Clermont Ave shot # 1.'}, 
        {key: 3, highResImage: chineseCabinet, compressedImage: chineseCabinetCompressed, width: 1000, height: 1500, alt: 'Ornate black and gold chinese cabinet.'}, 
        {key: 4, highResImage: livingRoom2, compressedImage: livingRoom2Compressed, width: 1200, height: 1800, alt: '72 Clermont Ave shot # 2.'}, 
        {key: 5, highResImage: livingRoom3, compressedImage: livingRoom3Compressed, width: 1200, height: 1800, alt: '72 Clermont Ave shot # 3.'}, 
        {key: 6, highResImage: bathroom1, compressedImage: bathroom1Compressed, width: 1300, height: 1950, alt: 'Bathroom shot 1.'}, 
        {key: 7, highResImage: bathroom2, compressedImage: bathroom2Compressed, width: 1300, height: 1950, alt: 'Bathroom shot 2.'}, 
        {key: 8, highResImage: flowers, compressedImage: flowersCompressed, width: 1067, height: 1600, alt: 'Bouquet of flowers.'}, 
        {key: 9, highResImage: diningRoom, compressedImage: diningRoomCompressed, width: 1000, height: 1500, alt: "Edie's parent's living room."}, 
        {key: 10, highResImage: bedroom1, compressedImage: bedroom1Compressed, width: 933, height: 1400, alt: 'Dog sitting on bed in front of portrait in the background.'}, 
        {key: 11, highResImage: grammieKitchen, compressedImage: grammieKitchenCompressed, width: 1105, height: 1600, alt: "Edie's grandma's kitchen." }, 
        {key: 12, highResImage: nightstand1, compressedImage: nightstand1Compressed, width: 1067, height: 1600, alt: 'Nightstand photo 1.'}, 
        {key: 13, highResImage: nightstand2, compressedImage: nightstand2Compressed, width: 1333, height: 2000,  alt: 'Nightstand photo 2.'}, 
        {key: 14, highResImage: NYT, compressedImage: NYTCompressed, width: 1800, height: 1200, alt: 'Copy of the NYT laid out on a dining room table.'} 
    ]
